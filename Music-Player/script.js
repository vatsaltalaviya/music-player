...
var poster = document.querySelector("#thumbnail")
var playbtn = document.querySelector("#play")
var forward = document.querySelector("#forward")
var backward = document.querySelector("#backward")
var timer = document.querySelector("#timer")
var songtitle = document.querySelector("#track")
var currentSong = 0
let audio = new Audio()
...
audio.addEventListener("timeupdate", function () {
    ...
    document.querySelector(".thumb").style.width = (audio.currentTime / audio.duration) * 100 + "%"
})

//to move thumb in the range
document.querySelector(".range").addEventListener("click", function (e) {
    let percent = (e.offsetX / e.target.getBoundingClientRect().width) * 100
    // console.log(percent);
    document.querySelector(".thumb").style.width = percent + "%"
